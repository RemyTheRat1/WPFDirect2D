...
namespace TestApp
{
    public class MainViewModel
    {
        ...
        private readonly Action _renderRequest;

        public MainViewModel(Action renderRequest)
        {
            _renderRequest = renderRequest;
            RequestRenderCommand = new DelegateCommand(() => _renderRequest());
        ...
        public ICommand RequestRenderCommand { get; private set; }
